package com.bank.bian.customercasemanagement.model;
...
/**
 * The BIAN control record for this service domain: "Customer Case Management Plan".
 *
 ...
 * to its asset type (Customer Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Case Management Plan";
